...
public class MainWindow : GameWindow
{
    ...
    protected override void OnLoad()
    {
        ...
        */
        ...
        float scale = 2;
        gameObjects.Add(
            new GameObject("res\\Assets\\Models\\Bookcase\\model.obj",
                new Vector3(0, 0.5f, 0),
                new Vector3(scale))
        );
        gameObjects[0].Name = "Bookshelf"; // TODO: Remove
        
        gameObjects.Add(
            new GameObject("res\\Assets\\Models\\plane.obj",
                new Vector3(0, 0, 0),
                new Vector3(5))
        );
        ...
        camera = new Camera(new Vector3(0, 1, 0), Size.X / (float)Size.Y);
    ...
    protected override void OnUpdateFrame(FrameEventArgs e)
    {
        ...
        const float GRAVITY = 0;//-9.81f;
        bool cameraCollision = false;

        foreach (var gameObject in gameObjects)
        {
            if (gameObject.CheckCollision(camera.Position))
            {
